...
public class specialChessGameFrame extends JFrame {
    ...
    private specialChessboardComponent chessboardComponent;
    ...
    public specialChessGameFrame(int width, int height,int initialStep) throws IOException {
        ...
        ImageIcon icon=new ImageIcon("lib/picture/special.png");
        JLabel label=new JLabel(icon);

        //设置label的大小
        label.setBounds(-20,0,icon.getIconWidth(),icon.getIconHeight());
    ...
    public specialChessboardComponent getChessboardComponent(){
        return chessboardComponent;
    }
    private void addChessboard() {
        chessboardComponent = new specialChessboardComponent(ONE_CHESS_SIZE);
    ...
    private void addLabel() {
        JLabel statusLabel = new JLabel("SpecialMode");
    ...
    private void addSijuButton() {
        ...
        shuffleButton.setLocation(5, 10);
        shuffleButton.setSize(150, 50);
        shuffleButton.setFont(new Font("Shuffle", Font.ITALIC, 20));
    ...
    private void addHintButton() {
        ...
        button.setLocation(5, 80);
        button.setSize(150, 50);
        button.setFont(new Font("Hint", Font.ITALIC, 20));
        button.setBackground(Color.cyan);
        add(button);
    }

    private void addHammerButton(){
        JButton button = new JButton("Hammer");
        button.addActionListener((e) -> chessboardComponent.hammer());
        button.setLocation(5, 150);
        button.setSize(150, 50);
        button.setFont(new Font("Hint", Font.ITALIC, 20));
    ...
    public static void pass(){
        JOptionPane.showMessageDialog(null,"You have passed all the levels");
    }

    public static void barrier(){
        JOptionPane.showMessageDialog(null,"You can't swap a barrier.");
    }

    public static void noPoint(){
        JOptionPane.showMessageDialog(null,"You haven't select a chess.");
    }

    public static void moreThanOnePoint(){
        JOptionPane.showMessageDialog(null,"You can only select one chess to use the hammer.");
    }

    public static void notBarrier(){
        JOptionPane.showMessageDialog(null,"You can't use at a chess that is not a barrrier.");
    }
