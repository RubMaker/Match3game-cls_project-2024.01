...
public class debateChessboardComponent extends JComponent {
    ...
    private debateGameController gameController;

    public debateGameController getGameController() {return gameController;}
    public debateChessboardComponent(int chessSize) {
    ...
    public void registerController(debateGameController gameController) {
        this.gameController = gameController;
    }

    public void fallDownforinit(int x,int y,int dis,ChessPiece chess,int id) {
        //将目标格子移动的x,y
        //清空xy
