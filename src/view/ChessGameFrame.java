...
public class ChessGameFrame extends JFrame {
    ...
    public ChessGameFrame(int width, int height,int initialStep) throws IOException {
        ...
        ImageIcon icon=new ImageIcon("lib/picture/GamePlay.png");
    ...
    private void addNewGameButton() {
        ...
        button.addActionListener((e) ->
        {
            ...
            newGameNoticeFrame newGame=new newGameNoticeFrame(level);
    ...
    private void addResetButton() {
        ...
        //button.addActionListener((e) -> chessboardComponent.resetChess());
        button.setLocation(5, HEIGHT/2);
        button.setSize(150, 50);
        button.setFont(new Font("reset", Font.ITALIC, 20));
        add(button);
    }
